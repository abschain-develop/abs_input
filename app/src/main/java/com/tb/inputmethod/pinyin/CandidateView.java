...
public class CandidateView extends View {
    private static final String THIS_FILE = "CandidateView";
    /**
...
//        mCandidateMargin = r.getDimension(R.dimen.candidate_margin_left_right);
        mCandidateMargin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 12, getResources().getDisplayMetrics());
    ...
    public void setDecodingInfo(PinyinIME.DecodingInfo decInfo) {
        ...
        // TODO mCandidateTextSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 16, getResources().getDisplayMetrics());
        Log.i(THIS_FILE, "mCandidateTextSize:" + mCandidateTextSize);
        Log.i(THIS_FILE, "mRecommendedCandidateTextSize:" + mRecommendedCandidateTextSize);
        Log.i(THIS_FILE, "mImeCandidateTextSize:" + mImeCandidateTextSize);
...
//        }
        ...
        int textSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 16, getResources().getDisplayMetrics());
        mCandidatesPaint.setTextSize(textSize);
        mFmiCandidates = mCandidatesPaint.getFontMetricsInt();
    ...
    private boolean calculatePage(int pageNo) {
        ...
        Log.i(THIS_FILE, "mDecInfo.mPageStart.size() > pageNo + 1");
        Log.i(THIS_FILE, "mDecInfo.mPageStart.size():" + mDecInfo.mPageStart.size());
        Log.i(THIS_FILE, "pageNo + 1:" + (pageNo + 1));
...
//                itemWidth += mSeparatorDrawable.getIntrinsicWidth();
            ...
            if (!onlyExtraMargin) {
                Log.i(THIS_FILE, "!onlyExtraMargin");
                mDecInfo.mPageStart.add(pStart + pSize);
                Log.i(THIS_FILE, "!onlyExtraMargin pStart + pSize:" + (pStart + pSize) + "," + mDecInfo.mPageStart.size());
                mDecInfo.mCnToPage.add(mDecInfo.mCnToPage.get(p) + charNum);
                Log.i(THIS_FILE, "!onlyExtraMargin mDecInfo.mCnToPage.get(p) + charNum:" + (mDecInfo.mCnToPage.get(p) + charNum));
            }

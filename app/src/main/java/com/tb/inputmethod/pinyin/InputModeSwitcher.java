...
public class InputModeSwitcher {
    private static final String THIS_FILE = "InputModeSwitcher";
    /**
     ...
     * User defined key code, used by soft keyboard.
     */
    private static final int USERDEF_KEYCODE_ENCRYPT_7 = -7;
    private static final int USERDEF_KEYCODE_DECRYPT_8 = -8;
    private static final int USERDEF_KEYCODE_DECRYPT_CLOSE_9 = -9;
     ...
     * 九宫格中文键盘
     */
    private static final int MASK_SKB_LAYOUT_T9 = 0x60000000;

    private static final int MASK_SKB_DECRYPTED_LAYOUT = 0x70000000;
    ...
    public static final int MODE_SKB_DECRYPTED_LAYOUT = (MASK_SKB_DECRYPTED_LAYOUT);
    ...
    public int getSkbLayout() {
        Log.d(THIS_FILE, "mInputMode:" + mInputMode);
        int layout = (mInputMode & MASK_SKB_LAYOUT);
        Log.i("ABS", "getSkbLayout" + layout);

        switch (layout) {
            case MASK_SKB_LAYOUT_QWERTY:
                Log.i("ABS", "getSkbLayout MASK_SKB_LAYOUT_QWERTY");
                return R.xml.skb_qwerty;
            case MASK_SKB_LAYOUT_SYMBOL1:
                Log.i("ABS", "getSkbLayout MASK_SKB_LAYOUT_SYMBOL1");
                return R.xml.skb_sym1;
            case MASK_SKB_LAYOUT_SYMBOL2:
                Log.i("ABS", "getSkbLayout MASK_SKB_LAYOUT_SYMBOL2");
                return R.xml.skb_sym2;
            case MASK_SKB_LAYOUT_SMILEY:
                Log.i("ABS", "getSkbLayout MASK_SKB_LAYOUT_SMILEY");
                return R.xml.skb_smiley;
            case MASK_SKB_LAYOUT_PHONE:
                Log.i("ABS", "getSkbLayout MASK_SKB_LAYOUT_PHONE");
                return R.xml.skb_phone;
            case MASK_SKB_DECRYPTED_LAYOUT:
                Log.i("ABS", "getSkbLayout MASK_SKB_DECRYPTED_LAYOUT");
                return R.xml.skb_decrypted;
        }
        return 0;
    }
    ...
    public int switchModeForUserKey(int userKey) {
        ...
        } else if (USERDEF_KEYCODE_ENCRYPT_7 == userKey) {
            Log.i("ABS_INPUT", "USERDEF_KEYCODE_ENCRYPT_7");
        } else if (USERDEF_KEYCODE_DECRYPT_8 == userKey) {
            Log.d(THIS_FILE, "USERDEF_KEYCODE_DECRYPT_8");
            // 解密展示
            newInputMode = MODE_SKB_DECRYPTED_LAYOUT;
        } else if (USERDEF_KEYCODE_DECRYPT_CLOSE_9 == userKey) {
            // 解密展示后关闭
            newInputMode = MODE_SKB_CHINESE;
        }

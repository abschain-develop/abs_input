...
//               mKeyHeight = (int) (mScreenHeight * KEY_HEIGHT_RATIO_PORTRAIT);
                ...
                // 按键高度
                mKeyHeight = (int) (40 *  context.getResources().getDisplayMetrics().density + 0.5f);
//                mCandidatesAreaHeight = (int) (mScreenHeight * CANDIDATES_AREA_HEIGHT_RATIO_PORTRAIT);
                mCandidatesAreaHeight = (int) (40 *  context.getResources().getDisplayMetrics().density + 0.5f);
                scale = mScreenWidth;
            } else {
            ...
            // 普通按键文字大小（16dp）
            mNormalKeyTextSize = (int) (16 *  context.getResources().getDisplayMetrics().density + 0.5f);
//            mNormalKeyTextSize = (int) (scale * NORMAL_KEY_TEXT_SIZE_RATIO);
            // 功能按键文字大小（16dp）
//            mFunctionKeyTextSize = (int) (scale * FUNCTION_KEY_TEXT_SIZE_RATIO);
            mFunctionKeyTextSize = (int) (16 *  context.getResources().getDisplayMetrics().density + 0.5f);
    ...
    public int getSkbHeight() {
        if (Configuration.ORIENTATION_PORTRAIT == mConfig.orientation) {
            return (int) (220 *  this.scale + 0.5f);
